...
--
-- Host: localhost
-- Generation Time: Nov 30, 2015 at 06:00 AM
...
INSERT INTO `Album` (`album_id`, `album_title`, `released_date`, `cover_image_id`, `publisher_id`) VALUES
...
INSERT INTO `Song` (`song_id`, `song_title`, `duration`, `language`, `genre_id`, `lyrics_id`, `video_id`) VALUES
(1000, 'Neon', 263, 'English', 1000, 1000, 1000),
(1001, 'Say', 223, 'English', 1000, 1001, 1001),
(1002, 'Circus', 213, 'English', 1000, 1002, 1002),
(1003, 'Womanizer', 226, 'English', 1000, 1003, 1003),
(1004, 'I''m Not A Girl, Not Yet A Woman', 228, 'English', 1000, 1004, 1004),
(1005, 'Shake It Off', 241, 'English', 1000, 1005, 1005),
(1006, 'Wildest Dreams', 234, 'English', 1000, 1006, 1006),
(1007, 'Just Give Me a Reason', 242, 'English', 1000, 1007, 1007),
(1008, 'Call Me Maybe', 199, 'English', 1000, 1008, 1008),
(1009, 'A Little Bit Stronger', 278, 'English', 1000, 1009, 1009),
(1010, 'Bamboleo', 203, 'Spanish', 1000, 1010, 1010),
(1011, 'Bohemian Rhapsody', 366, 'English', 1001, 1011, 1011),
(1012, 'We Will Rock You', 134, 'English', 1001, 1012, 1012),
(1013, 'Clarity', 275, 'English', 1000, 1013, 1013),
(1014, 'Jump', 241, 'English', 1001, 1014, 1014);
