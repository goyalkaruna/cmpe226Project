...
<body>
  ...
  <div class="container">
<h3><p class="lead"><I>User History</I> </p></h3>

    <p>
        <?php
           include ('include/dbConnect.php');

                    $query = "SELECT History.user_id, Song.title, HistorySong.played_at FROM History, HistorySong, Song WHERE History.history_id = HistorySong.history_id AND HistorySong.song_id = Song.song_id";
