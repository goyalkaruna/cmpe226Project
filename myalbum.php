    ...
    <p>
        <?php
           include ('include/dbConnect.php');
                    ...
                    $query = "SELECT * FROM UserAlbum ua, UserAlbumSong uas, Song s WHERE ua.user_id = :id
                    AND ua.user_album_id = uas.user_album_id AND s.song_id= uas.song_id";

                        $ps = $con->prepare ( $query );
                        $ps->bindParam ( ':id', $_SESSION ['sess_id'] );
                        $ps->execute ();
                ...
                $doHeader = true;
                    ...
                    if ($doHeader) {
                      ...
                      echo "<table>";
                      echo "<tr><th>Title</th><th>Duration</th><th>Language</th><th>Song</th></tr>";
                      foreach( $data as $row) {
                          echo "<tr>";
