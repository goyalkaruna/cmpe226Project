...
include ('include/dbConnect.php');
             ...
             $duration = filter_input(INPUT_POST, "duration");
              ...
              $sql_video = "INSERT INTO Song(song_title, duration, genre_id, video_id, language) VALUES('$title', '$duration','$genre_id','$video_id', '$language')";
              $con->exec($sql_video);
              echo "<label><Strong> Success!!!!</Strong> New record created in the song table successfully. <label></br> " ;
